...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__album_album_component__ = __webpack_require__("./src/app/album/album.component.ts");
...
var routes = [
    {
        ...
        children: [
            ...
            {
                path: "dash",
                component: __WEBPACK_IMPORTED_MODULE_8__dash_dash_component__["a" /* DashComponent */],
            },
            {
                path: "orders",
                component: __WEBPACK_IMPORTED_MODULE_10__order_order_component__["a" /* OrdersComponent */],
            },
            {
                path: "products",
                component: __WEBPACK_IMPORTED_MODULE_12__product_product_component__["a" /* ProductsComponent */],
            },
            {
                path: "customers",
                component: __WEBPACK_IMPORTED_MODULE_7__customer_customer_component__["a" /* CustomersComponent */],
            },
            {
                path: "albums",
                component: __WEBPACK_IMPORTED_MODULE_3__album_album_component__["a" /* AlbumComponent */],
            },
            {
                path: "pricing",
            ...
            {
                path: "blog",
                component: __WEBPACK_IMPORTED_MODULE_4__blog_blog_component__["a" /* BlogComponent */],
            },
        ],
    },
    {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__dash_dash_component__ = __webpack_require__("./src/app/dash/dash.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__order_order_component__ = __webpack_require__("./src/app/order/order.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__checkout_checkout_component__ = __webpack_require__("./src/app/checkout/checkout.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__cover_cover_component__ = __webpack_require__("./src/app/cover/cover.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__blog_blog_component__ = __webpack_require__("./src/app/blog/blog.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_13__order_order_component__["a" /* OrdersComponent */],
                __WEBPACK_IMPORTED_MODULE_14__product_product_component__["a" /* ProductsComponent */],
                __WEBPACK_IMPORTED_MODULE_15__customer_customer_component__["a" /* CustomersComponent */],
                ...
                __WEBPACK_IMPORTED_MODULE_19__checkout_checkout_component__["a" /* CheckoutComponent */],
                __WEBPACK_IMPORTED_MODULE_20__cover_cover_component__["a" /* CoverComponent */],
                __WEBPACK_IMPORTED_MODULE_21__blog_blog_component__["a" /* BlogComponent */],
            ],
            imports: [
...
module.exports = "<main role=\"main\" class=\"col-md-9 col-lg-10 pt-3 px-4 mt-5\">\n  <div\n    class=\"d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom\"\n  >\n    <h1 class=\"h2\">Chart</h1>\n    <div class=\"btn-toolbar mb-2 mb-md-0\">\n      <div class=\"btn-group mr-2\">\n        <button class=\"btn btn-sm btn-outline-secondary\">Share</button>\n        <button class=\"btn btn-sm btn-outline-secondary\">Export</button>\n      </div>\n      <button class=\"btn btn-sm btn-outline-secondary dropdown-toggle\">\n        <span data-feather=\"calendar\"></span>\n        This week\n      </button>\n    </div>\n  </div>\n\n  <div style=\"width: 100%; height: 100%\">\n    <canvas class=\"my-4\" id=\"myChart\" width=\"900\" height=\"380\" #canvas></canvas>\n  </div>\n\n  <h2>Data</h2>\n  <div class=\"table-responsive\">\n    <table class=\"table table-striped table-sm\">\n      <thead>\n        <tr>\n          <th>#</th>\n          <th>Header</th>\n          <th>Header</th>\n          <th>Header</th>\n          <th>Header</th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr>\n          <td>1,001</td>\n          <td>Lorem</td>\n          <td>ipsum</td>\n          <td>dolor</td>\n          <td>sit</td>\n        </tr>\n        <tr>\n          <td>1,002</td>\n          <td>amet</td>\n          <td>consectetur</td>\n          <td>adipiscing</td>\n          <td>elit</td>\n        </tr>\n        <tr>\n          <td>1,003</td>\n          <td>Integer</td>\n          <td>nec</td>\n          <td>odio</td>\n          <td>Praesent</td>\n        </tr>\n        <tr>\n          <td>1,003</td>\n          <td>libero</td>\n          <td>Sed</td>\n          <td>cursus</td>\n          <td>ante</td>\n        </tr>\n        <tr>\n          <td>1,004</td>\n          <td>dapibus</td>\n          <td>diam</td>\n          <td>Sed</td>\n          <td>nisi</td>\n        </tr>\n        <tr>\n          <td>1,005</td>\n          <td>Nulla</td>\n          <td>quis</td>\n          <td>sem</td>\n          <td>at</td>\n        </tr>\n        <tr>\n          <td>1,006</td>\n          <td>nibh</td>\n          <td>elementum</td>\n          <td>imperdiet</td>\n          <td>Duis</td>\n        </tr>\n        <tr>\n          <td>1,007</td>\n          <td>sagittis</td>\n          <td>ipsum</td>\n          <td>Praesent</td>\n          <td>mauris</td>\n        </tr>\n        <tr>\n          <td>1,008</td>\n          <td>Fusce</td>\n          <td>nec</td>\n          <td>tellus</td>\n          <td>sed</td>\n        </tr>\n        <tr>\n          <td>1,009</td>\n          <td>augue</td>\n          <td>semper</td>\n          <td>porta</td>\n          <td>Mauris</td>\n        </tr>\n        <tr>\n          <td>1,010</td>\n          <td>massa</td>\n          <td>Vestibulum</td>\n          <td>lacinia</td>\n          <td>arcu</td>\n        </tr>\n        <tr>\n          <td>1,011</td>\n          <td>eget</td>\n          <td>nulla</td>\n          <td>Class</td>\n          <td>aptent</td>\n        </tr>\n        <tr>\n          <td>1,012</td>\n          <td>taciti</td>\n          <td>sociosqu</td>\n          <td>ad</td>\n          <td>litora</td>\n        </tr>\n        <tr>\n          <td>1,013</td>\n          <td>torquent</td>\n          <td>per</td>\n          <td>conubia</td>\n          <td>nostra</td>\n        </tr>\n        <tr>\n          <td>1,014</td>\n          <td>per</td>\n          <td>inceptos</td>\n          <td>himenaeos</td>\n          <td>Curabitur</td>\n        </tr>\n        <tr>\n          <td>1,015</td>\n          <td>sodales</td>\n          <td>ligula</td>\n          <td>in</td>\n          <td>libero</td>\n        </tr>\n      </tbody>\n    </table>\n  </div>\n</main>\n\n<form action=\"#\" class=\"credit-card-div col-md-4 mt-5 text-center\">\n  <div class=\"panel panel-default\">\n    <div class=\"panel-heading\">\n      <div class=\"row\">\n        <div class=\"col-md-12\">\n          <input\n            type=\"text\"\n            class=\"form-control\"\n            placeholder=\"Enter Card Number\"\n          />\n        </div>\n      </div>\n      <div class=\"row\">\n        <div class=\"col-md-3 col-sm-3 col-xs-3\">\n          <span class=\"help-block text-muted small-font\"> Expiry Month</span>\n          <input type=\"text\" class=\"form-control\" placeholder=\"MM\" />\n        </div>\n        <div class=\"col-md-3 col-sm-3 col-xs-3\">\n          <span class=\"help-block text-muted small-font\"> Expiry Year</span>\n          <input type=\"text\" class=\"form-control\" placeholder=\"YY\" />\n        </div>\n        <div class=\"col-md-3 col-sm-3 col-xs-3\">\n          <span class=\"help-block text-muted small-font\"> CCV</span>\n          <input type=\"text\" class=\"form-control\" placeholder=\"CCV\" />\n        </div>\n        <div class=\"col-md-3 col-sm-3 col-xs-3\">\n          <img src=\"assets/img/1.png\" class=\"img-rounded\" />\n        </div>\n      </div>\n      <div class=\"row\">\n        <div class=\"col-md-12 pad-adjust\">\n          <input\n            type=\"text\"\n            class=\"form-control\"\n            placeholder=\"Name On The Card\"\n          />\n        </div>\n      </div>\n      <div class=\"row\">\n        <div class=\"col-md-12 pad-adjust\">\n          <div class=\"checkbox\">\n            <label>\n              <input type=\"checkbox\" checked class=\"text-muted\" /> Save details\n              for fast payments <a href=\"#\"> learn how ?</a>\n            </label>\n          </div>\n        </div>\n      </div>\n      <div class=\"row\">\n        <div class=\"col-md-6 col-sm-6 col-xs-6 pad-adjust\">\n          <input type=\"submit\" class=\"btn btn-danger\" value=\"CANCEL\" />\n        </div>\n        <div class=\"col-md-6 col-sm-6 col-xs-6 pad-adjust\">\n          <input\n            type=\"submit\"\n            class=\"btn btn-warning btn-block\"\n            value=\"PAY NOW\"\n          />\n        </div>\n      </div>\n    </div>\n  </div>\n</form>\n"
...
module.exports = "<div\n  class=\"d-flex flex-column flex-grow flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow full-width\"\n>\n  <h5 class=\"my-0 mr-md-auto ml-5 font-weight-normal\">Demo</h5>\n  <nav class=\"my-2 my-md-0 mr-md-3\">\n    <a class=\"p-2 text-dark\" href=\"#\">Features</a>\n    <a class=\"p-2 text-dark\" href=\"#\">Enterprise</a>\n    <a class=\"p-2 text-dark\" href=\"#\">Support</a>\n    <a class=\"p-2 text-dark\" href=\"#\" [routerLink]=\"['/pricing']\">Pricing</a>\n  </nav>\n  <a class=\"btn btn-outline-primary\" href=\"#\" [routerLink]=\"['/customers']\"\n    >Sign up</a\n  >\n</div>\n"
...
module.exports = "<div class=\"container-fluid\">\n  <div class=\"row\">\n    <nav\n      class=\"col-md-10 d-none d-md-block bg-light sidebar\"\n      style=\"height: 100vh\"\n    >\n      <div class=\"sidebar-sticky\">\n        <ul class=\"nav flex-column\">\n          <li class=\"nav-item\">\n            <a class=\"nav-link active\" href=\"#\" [routerLink]=\"['/dash']\">\n              <span data-feather=\"home\"></span>\n              Dashboard <span class=\"sr-only\">(current)</span>\n            </a>\n          </li>\n          <li class=\"nav-item\">\n            <a class=\"nav-link\" href=\"#\" [routerLink]=\"['/chart']\">\n              <span data-feather=\"file\"></span>\n              Orders\n            </a>\n          </li>\n          <li class=\"nav-item\">\n            <a class=\"nav-link\" href=\"#\" [routerLink]=\"['/products']\">\n              <span data-feather=\"shopping-cart\"></span>\n              Products\n            </a>\n          </li>\n          <li class=\"nav-item\">\n            <a class=\"nav-link\" href=\"#\" [routerLink]=\"['/customers']\">\n              <span data-feather=\"users\"></span>\n              Customers\n            </a>\n          </li>\n          <li class=\"nav-item\">\n            <a class=\"nav-link\" href=\"#\" [routerLink]=\"['/blog']\">\n              <span data-feather=\"bar-chart-2\"></span>\n              Blog\n            </a>\n          </li>\n\n          <li class=\"nav-item\">\n            <a class=\"nav-link\" href=\"#\" [routerLink]=\"['/albums']\">\n              <span data-feather=\"layers\"></span>\n              Albums\n            </a>\n          </li>\n\n          <li class=\"nav-item\">\n            <a class=\"nav-link\" href=\"#\" [routerLink]=\"['/pricing']\">\n              <span data-feather=\"layers\"></span>\n              Pricing\n            </a>\n          </li>\n\n          <li class=\"nav-item\">\n            <a class=\"nav-link\" href=\"#\" [routerLink]=\"['/checkout']\">\n              <span data-feather=\"layers\"></span>\n              Checkout\n            </a>\n          </li>\n\n          <li class=\"nav-item\">\n            <a class=\"nav-link\" href=\"#\" [routerLink]=\"['/']\">\n              <span data-feather=\"layers\"></span>\n              Root?\n            </a>\n          </li>\n        </ul>\n      </div>\n    </nav>\n  </div>\n</div>\n"
